      ...
      <?php
        ...
        while ($row = mysqli_fetch_assoc($result))
        {
          ...
          ?>
              ...
              <form class="form-horizontal" action="mail_handler.php" method="post" name="form">
                ...
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  ...
                  <div class="form-group">
                    <label class="col-sm-5 control-label"></label>
                    <div class="col-sm-4">
                      <input type="submit" name="submit" value="Send Notice" class="btn btn-danger">
                      <input type="hidden" name="mail" value=<?php echo $row['division'];?> >
